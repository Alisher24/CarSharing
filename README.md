...
- API раз в секунду переводит истёкшие брони в `expired`, а в demo-профиле раз в пять секунд подтверждает телеметрию неподвижных автомобилей.
...
они намеренно ждут реального времени и занимают несколько минут.

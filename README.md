...
`demo_user_password`. Последний — пароль двух демоаккаунтов ручной проверки; остальные
подготовлены для будущих функций и пока не подключены к сервисам. Установка, созданная до

...
import type { AnswerHandlers, DocumentKind, PublicDocumentKind } from './readCycle.ts';

/** Every public resource the catalog reads, in the order the interface shows them. */
export const PUBLIC_DOCUMENT_KINDS: readonly PublicDocumentKind[] = ['vehicles', 'zones', 'tariffs'];

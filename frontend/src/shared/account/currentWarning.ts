import type { CurrentSnapshot } from '../api/current.ts';
import type { Notification, NotificationCollection, ReservationExpiringNotification } from '../api/notifications.ts';
import { currentRental } from '../ride/serverClock.ts';
import { vehicleName } from '../ride/spell.ts';

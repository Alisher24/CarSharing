import { sameOriginRequest } from '../api/request.ts';
...
// the public stream sends it as well and is unaffected by it. What this module adds to the seam is
// the representation it asks for: a stream of events rather than one answer.
const STREAM_REQUEST = { headers: { Accept: 'text/event-stream' }, ...sameOriginRequest } as const;
